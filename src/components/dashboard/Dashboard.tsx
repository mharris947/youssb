      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.isLedger ? (
            <div className="border flex flex-col gap-6 bg-[#0c2074] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#0c2074] text-[14px]">
                  Send money
                </Link>
              </div>
            </div>
          ) : user.bank_details.isChecking ? (
            <div className="flex flex-col justify-between gap-4 bg-[#0c2074] text-white p-4 rounded-lg">
              ...
              <div className="flex justify-between gap-6">
                ...
                <div className="flex flex-col gap-5">
                  <Link href="/dashboard/transfer" className="p-[5px_20px] flex rounded-full bg-white text-[#0c2074] text-[14px]">
                    Send money
                  </Link>
                </div>
              </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link href="/dashboard/cards" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#0c2074] rounded-full">
              <CardIcon className="w-5 h-5" /> <span>Cards</span>
            </Link>
            <Link href="/dashboard/bill-payment" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#0c2074] rounded-full">
        ...
        <div className="border flex flex-col gap-4 p-6 px-4">
          <div className="border flex flex-col gap-4 bg-white overflow-hidden">
            <Image src="https://i.imgur.com/TYHhsh0.png" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-center text-black p-3 px-7 pb-7">
              <span className="font-bold">Fund your goals</span> <br />
              <span>Wondering about personal lines of credit? Here's what to know.</span>
            </div>
          </div>
          <div className="border flex flex-col gap-4 bg-white overflow-hidden">
            <Image src="https://i.imgur.com/8xb5Ylq.png" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-center text-black p-3 px-7 pb-7">
              <span className="font-bold">Life seasons</span> <br />
              <span>How to fine-tune your finances as an empty nester</span>
            </div>
          </div>
        </div>
      </div>
