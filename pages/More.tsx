    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-1">
        <div className="banking-card flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-[#223e99] flex items-center justify-center text-[#0c2074]-foreground text-2xl font-bold">
              ...
              if (item.path) {
                return (
                  <Link
                    key={item.label}
                    href={item.path}
                    className="w-full flex items-center gap-4 p-4 hover:bg-[#0c2074]/50 transition-colors text-left"
                  >
