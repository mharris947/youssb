...
const budgets = [
  ...
  { id: 3, category: 'Transportation', allocated: 200, spent: 156.8, color: 'bg-[#0c2074]' },
    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-2">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-sm text-[#0c2074] font-medium">Edit</button>
        </div>
              ...
              <div key={budget.id} className="banking-card">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-sm font-medium ${isOver ? 'text-[#ef4343]' : 'text-[#1fad53]'}`}
                    >
                ...
                <div className="h-2 bg-[#0c2074] rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all ${isOver ? 'bg-[#ef4343]' : budget.color}`}
      ...
      {/* <section className="px-5 animate-fade-up stagger-3">
        ...
        border-dashed border-gray-200 hover:border-primary hover:bg-[#0c2074]/5 transition-all"
        >
