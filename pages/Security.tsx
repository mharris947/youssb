    ...
    <div className="min-h-screen bg-background pb-28">
      <header className="px-5 pt-12 pb-6 animate-fade-up">
        <div className="flex items-center gap-4">
          <Link
            href="/more"
            className="p-2 -ml-2 rounded-full hover:bg-[#0c2074] transition-colors"
          >
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-1">
        <div className="banking-card bg-[#223e99] text-[#0c2074]-foreground">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-2">
        ...
        <div className="banking-card p-0! overflow-hidden divide-y divide-border">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-4">
              <div className="p-2.5 rounded-xl bg-[#0c2074]">
            ...
            <button
              ...
              className={`relative w-12 h-7 rounded-full transition-colors ${
                biometricsEnabled ? 'bg-[#0c2074]' : 'bg-[#0c2074]'
              }`}
            >
              <div
          ...
          <div className="flex items-center justify-between p-4">
            ...
            <button
              ...
              className={`relative w-12 h-7 rounded-full transition-colors ${
                twoFactorEnabled ? 'bg-[#0c2074]' : 'bg-[#0c2074]'
              }`}
            >
              <div
                className={`absolute top-1 w-5 h-5 rounded-full bg-white shadow transition-transform ${
          ...
          <button className="w-full flex items-center justify-between p-4 hover:bg-[#0c2074]/50 transition-colors">
            <div className="flex items-center gap-4">
              <div className="p-2.5 rounded-xl bg-[#0c2074]">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-3">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-sm text-[#0c2074] font-medium">Manage</button>
        </div>
