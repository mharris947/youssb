    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-1">
        <div className="banking-card">
          ...
          <button className="mt-4 w-full py-3 rounded-xl bg-[#223e99] text-[#0c2074]-foreground font-medium">
            Pay All Bills
          </button>
        </div>
      </section>
      ...
      <section className="px-5 mb-6 animate-fade-up stagger-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-sm text-[#0c2074] font-medium">See All</button>
        </div>
        <div className="space-y-3">
          {billers.map(bill => (
            ...
            >
              <div className="p-3 rounded-xl bg-[#0c2074]/10">
                <bill.icon className="w-5 h-5 text-[#0c2074]" />
              </div>
              ...
              <div className="text-right">
                ...
                <span className="text-xs px-2 py-0.5 rounded-full bg-[#0c2074] text-gray-500">
                  {bill.category}
                </span>
              </div>
            </button>
      ...
      <section className="px-5 animate-fade-up stagger-4">
        <button className="w-full flex items-center justify-center gap-3 p-4 rounded-2xl border-2 border-dashed border-gray-200 hover:border-primary hover:bg-[#0c2074]/5 transition-all">
