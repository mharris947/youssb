        ...
        <>
          ...
          <section className="px-5 animate-fade-up stagger-4">
            <button
              ...
              className="w-full py-4 rounded-2xl bg-[#223e99] text-[#0c2074]-foreground font-semibold disabled:opacity-50"
            >
              Continue
            </button>
          </section>
      ...
      {step === 3 && (
        <section className="px-5 animate-fade-up">
          <div className="banking-card text-center py-12">
            ...
            <div className="bg-[#0c2074] rounded-xl p-4 mb-6">
            ...
            <Link
              href="/"
              className="inline-block w-full py-4 rounded-2xl bg-white border border-gray-200 font-semibold text-foreground hover:bg-[#0c2074] transition-colors"
            >
              Back to Home
            </Link>
          </div>
