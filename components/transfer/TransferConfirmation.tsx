      ...
      <DetailRow label="From">
        <div className="text-right">
          ...
          <p className="text-sm text-gray-500">
            ••••{selectedFromAccount?.accountNumber?.slice(-4)}
          </p>
        </div>
      </DetailRow>
...
//     <div className="bg-[#0c2074]/10 rounded-2xl p-4 flex items-start gap-3">
//       <div className="p-1 rounded-full bg-[#0c2074]">
...
const ActionButtons = ({
  ...
  <section className="px-5 space-y-3 animate-fade-up stagger-4">
    ...
    <button
      onClick={onCancel}
      disabled={isProcessing}
      className="w-full py-4 cursor-pointer rounded-2xl bg-[#0c2074]/70 text-white font-semibold text-lg transition-colors hover:bg-[#0c2074] active:scale-[0.98] disabled:opacity-50"
    >
      Cancel
    </button>
  </section>
