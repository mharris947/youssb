...
const actions = [
  // { icon: Send, label: "Send", color: "bg-[#0c2074]/10 text-[#0c2074]", path: "/send" },
  {
    icon: ArrowLeftRight,
    label: 'Transfer',
    color: 'bg-[#e7b00833] text-accent-foreground',
    path: '/transfer'
  },
  {
    icon: CreditCard,
  ...
  // { icon: Wallet, label: "Budget", color: "bg-[#0c2074]/10 text-[#0c2074]", path: "/budget" },
];
